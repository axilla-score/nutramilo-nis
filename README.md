...
> an open-source algorithm designed to estimate the relative insulinogenic potential
> of a meal from its nutritional composition.  NIS is intended for research, educational use,
> software development, and exploratory nutritional analysis.
> It should not be interpreted as a validated clinical prediction model.
>
...
> is the planned confirmatory step (technical documentation).
...
| Open-source methodology | ❌ No | ✅ Yes |
...
print(result.citation)      # → "Inkov I. (2026). NIS … IJMRCR …"
```
...
| Artifact | Location |
|---|---|
| Frozen training dataset | To be archived in a public repository |
| Regression notebook | [`notebooks/independent_regression_v2.ipynb`](https://github.com/nutramilo/nutramilo-nis) |
| SHA-256 of v1.0 dataset | `b41eb157661b2d8ad0…`  |
| Unit tests | `pytest -q` — 13 tests, all should pass |
| Figures (PNG + TIFF 300dpi) |

## Scientific Status

NIS is currently presented as an exploratory methodology.

The algorithm has been evaluated during development using internal validation procedures and independent test subsets. Users should interpret outputs as comparative estimates rather than direct physiological measurements.

Further validation using independent cohorts and prospective studies may improve understanding of the model's performance and limitations.

## Scientific Background

The methodology underlying NIS is being prepared for scientific dissemination.

Citation information will be updated once a peer-reviewed publication or public preprint becomes available.
...
Trademark status subject to applicable registrations and filings.
...
NIS is intended for research and educational purposes.

Users are responsible for determining whether any particular use case may be subject to regulatory requirements in their jurisdiction.
